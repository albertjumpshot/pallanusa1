...
@section('page-title', 'Tambah Pengacara Baru')
@section('page-subtitle', 'Tambahkan profil pengacara baru ke tim firma')
            ...
            <form action="{{ route('admin.lawyers.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="education" name="education" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold focus:ring-opacity-20"
                              placeholder="Contoh: S.H. Universitas Indonesia, M.H. Universitas Gadjah Mada">{{ old('education') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea id="experience" name="experience" rows="4" required
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-gold focus:ring-2 focus:ring-gold focus:ring-opacity-20"
                              placeholder="Deskripsikan pengalaman kerja pengacara ini">{{ old('experience') }}</textarea>
                </div>
